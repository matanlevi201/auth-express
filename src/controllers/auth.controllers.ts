...
export const signup = async function (req: Request, res: Response, next: NextFunction) {
  ...
  req.currentUser = { id: user.id, email: user.email, is2FAEnabled: user.is2FAEnabled, is2FAVerified: false, isOauth2User: false };
  next();
};
...
export const signin = async function (req: Request, res: Response, next: NextFunction) {
  ...
  const currentUser = { id: user.id, email: user.email, is2FAEnabled: user.is2FAEnabled, is2FAVerified: false, isOauth2User: false };
...
export const googleRedirect = async function (req: Request, res: Response, next: NextFunction) {
  const payload = { ...req.user, is2FAEnabled: false, is2FAVerified: false, isOauth2User: true } as UserPayload;
